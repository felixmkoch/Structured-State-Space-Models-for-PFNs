...
transformer_model, mamba_model = get_model_both(config, device, should_train=True, verbose=1, mamba_autocast=mamba_autocast)#, evaluation_class=eval_class) # , state_dict=model[2].state_dict()
