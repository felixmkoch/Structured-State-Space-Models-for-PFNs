...
def get_model_both(config, device, should_train=True, verbose=0, state_dict=None, epoch_callback=None, mamba_autocast=True, evaluation_class=None):
    ...
    from tabpfn.both_train import train_both_models
    extra_kwargs = {}
    ...
    #------------------------------------------------------------------------------------------------
    #                               MAMBA AND TRANSFORMER TRAIN
    #------------------------------------------------------------------------------------------------

    mamba_model, transformer_model = train_both_models(model_proto.DataLoader
                  , loss
                  , encoder
    ...
    #------------------------------------------------------------------------------------------------
    #                             END MAMBA AND TRANSFORMER TRAIN
    #------------------------------------------------------------------------------------------------

    return mamba_model, transformer_model
