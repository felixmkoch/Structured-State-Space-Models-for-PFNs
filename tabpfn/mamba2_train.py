...
def train_mamba(priordataloader_class, 
          ...
          verbose=True,
          attn_layer_idx=None,      # Attention for Mamba2
          attn_cfg=None,            # Attention Config for Mamba2
    ...
    print("Beginning the Training process for Mamba2")
    ...
    try:
        for epoch in (range(1, epochs + 1) if epochs is not None else itertools.count(1)):
            ...
            #
            wandb_dict = {}
            wandb_dict["train/mamba2_loss"] = total_loss
            ...
            if evaluation_class:
                ...
                wandb_dict["test/mamba2_mean_acc"] = eval_result
